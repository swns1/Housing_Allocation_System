...
class SubmitBuyer extends Base {
    public function execute($data) {
        $stmt = $this->conn->prepare("INSERT INTO buyers (property_id, fullname, email, phone, message) VALUES (?, ?, ?, ?, ?)");
        $stmt->bind_param("issss", $data['property_id'], $data['fullname'], $data['email'], $data['phone'], $data['message']);
